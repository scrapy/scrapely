...
def longest_unique_subsequence(to_search, subsequence, range_start=0,
    ...
    matches = (
        (i, common_prefix_length(to_search[i:], subsequence))
        for i in xrange
        (range_start, range_end) if startval == to_search[i])
...
def similar_region(
        ...
        range_start=0,
        range_end=None,
        best_match=longest_unique_subsequence,
        **kwargs):
    ...
    (rpi,
     pscore) = best_match(reverse_tokens,
                          reverse_prefix,
                          data_length - range_end,
                          data_length - range_start)
